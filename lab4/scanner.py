...
class Scanner:
    def __init__(self):
        ...
        self.fa_identifiers = FiniteAutomata("fa_identifiers.in")
        self.fa_integer_constant = FiniteAutomata("fa_integer_constant.in")
    ...
    def is_identifier(self, token):
        return self.fa_identifiers.check_sequence(token)
    ...
    def is_integer(self, token):
        return self.fa_integer_constant.check_sequence(token)
